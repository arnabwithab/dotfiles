...
This skill detects and removes machine-generated writing patterns ("AI-isms") from text content to make AI-assisted writing sound natural and human.

## When to Use

Use this agent when:
- Auditing content for AI writing patterns
- Rewriting text to remove AI-isms
- Preparing content for LinkedIn, blog, or technical documentation
